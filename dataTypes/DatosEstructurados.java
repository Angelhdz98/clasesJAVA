...
public class DatosEstructurados {
	public static void main(String[] args) {
		...
		float gastosMensuales= 35864.3f;
		System.out.println(gastosMensuales);
		gastosMensuales= 42983.2f;
		System.out.println("ahora mis gastos ascendieron a"+ gastosMensuales);
		
		//variables finales o constantes valores que no cambian 
		final int SALARIO = 15000; 
		System.out.println(SALARIO);
		//SALARIO = 17400; //no nos permite debido a que esta variable es constante o final la buena practica es utilizar las constantes o finales con un nombre en mayusculas
